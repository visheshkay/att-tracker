        ...
        <div className="signinmain mt-5 mx-auto">
            ...
            <form className="mx-auto p-4 pt-3 bg-light formmain rounded" onSubmit={handleSubmit(login)}>
                <div className="radiobut">
                    <input type="radio" id="faculty" name="userType" value="student" checked="checked" {...register("userType")} />
                    <label for="user">Student</label>
                    <input type="radio" id="admin" name="userType" value="faculty" {...register("userType")} />
                    <label for="author">Faculty</label>
                </div>
                <div className="facid m-2 p-3 ">

                    <input type="text" id="facid" className="form-control w-75 mx-auto" placeholder='Id'{...register("roll", { required: true })} />
